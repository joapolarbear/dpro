...
# RST_DIR="./data_20200804_resnet50/v100/1"
...
RST_DIR="/Users/hhp/0/git/byteprofile-analysis/data/data_20200817_resnet50/v100_01"
...
# "network/resblock0_0/conv_0/conv2d/Conv2D",
# "network/resblock0_1/conv_init/conv2d/Conv2D",
# "network/resblock0_1/conv_1x1_front/conv2d/Conv2D",
# "network/resblock0_1/conv_1x1_back/conv2d/Conv2D",
# "network/resblock0_2/conv_init/conv2d/Conv2D",
# "network/resblock0_1/conv_0/conv2d/Conv2D",
# "network/resblock0_2/conv_1x1_front/conv2d/Conv2D",
# "network/resblock0_0/conv_init/conv2d/Conv2D",
# "network/resblock0_2/conv_1x1_back/conv2d/Conv2D",
# "network/resblock0_0/conv_1x1_front/conv2d/Conv2D",
# "network/resblock0_0/conv_1x1_back/conv2d/Conv2D",

# "network/resblock1_3/conv_0/conv2d/Conv2D",
# "network/resblock1_1/conv_0/conv2d/Conv2D",
# "network/resblock1_3/conv_1x1_front/conv2d/Conv2D",
# "network/resblock1_1/conv_1x1_back/conv2d/Conv2D",
# "network/resblock1_3/conv_1x1_back/conv2d/Conv2D",
# "network/resblock1_1/conv_init/conv2d/Conv2D",
# "network/resblock1_1/conv_1x1_front/conv2d/Conv2D",
# "network/resblock1_2/conv_init/conv2d/Conv2D",
# "network/resblock1_0/conv_init/conv2d/Conv2D",
# "network/resblock1_2/conv_1x1_front/conv2d/Conv2D",
# "network/resblock1_0/conv_1x1_front/conv2d/Conv2D",
# "network/resblock1_2/conv_1x1_back/conv2d/Conv2D",
# "network/resblock1_0/conv_1x1_back/conv2d/Conv2D",
# "network/resblock1_3/conv_init/conv2d/Conv2D",
# "network/resblock1_2/conv_0/conv2d/Conv2D",
# "network/resblock1_0/conv_0/conv2d/Conv2D",

# "network/resblock2_5/conv_1x1_front/conv2d/Conv2D",
# "network/resblock2_3/conv_0/conv2d/Conv2D",
# "network/resblock2_1/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_4/conv_1x1_front/conv2d/Conv2D",
# "network/resblock2_1/conv_0/conv2d/Conv2D",
# "network/resblock2_5/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_4/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_2/conv_init/conv2d/Conv2D",
# "network/resblock2_0/conv_init/conv2d/Conv2D",
# "network/resblock2_3/conv_init/conv2d/Conv2D",
# "network/resblock2_2/conv_1x1_front/conv2d/Conv2D",
# "network/resblock2_0/conv_1x1_front/conv2d/Conv2D",
# "network/resblock2_3/conv_1x1_front/conv2d/Conv2D",
# "network/resblock2_2/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_0/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_5/conv_0/conv2d/Conv2D",
# "network/resblock2_3/conv_1x1_back/conv2d/Conv2D",
# "network/resblock2_2/conv_0/conv2d/Conv2D",
# "network/resblock2_0/conv_0/conv2d/Conv2D",
# "network/resblock2_4/conv_0/conv2d/Conv2D",
# "network/resblock2_1/conv_init/conv2d/Conv2D",
# "network/resblock2_5/conv_init/conv2d/Conv2D",
# "network/resblock2_4/conv_init/conv2d/Conv2D",
# "network/resblock2_1/conv_1x1_front/conv2d/Conv2D",

# "network/resblock_3_2/conv_init/conv2d/Conv2D",
# "network/resblock_3_1/conv_1x1_back/conv2d/Conv2D",
# "network/resblock_3_1/conv_init/conv2d/Conv2D",
# "network/resblock_3_0/conv_1x1_front/conv2d/Conv2D",
# "network/resblock_3_1/conv_1x1_front/conv2d/Conv2D",
# "network/resblock_3_0/conv_1x1_back/conv2d/Conv2D",
# "network/resblock_3_1/conv_0/conv2d/Conv2D",
# "network/resblock_3_2/conv_0/conv2d/Conv2D",
# "network/resblock_3_0/conv_0/conv2d/Conv2D",
# "network/resblock_3_2/conv_1x1_front/conv2d/Conv2D",
...
OP_SHORT_LABELS = ["/".join(n.split("/")[1:3]) for n in OP_NAMES]

DOTS = ['.-', '^--', 'x-']


### model_size[node_name][S_mul, S_add, ...][len= # of batch value]
model_size = np.array([list(zip(*[meta_info.ret_tf_metadata(op_name, batch_size=b)[1:] for b in BATCH_LIST_VALUE])) for op_name in OP_NAMES])
# model_size = np.array([
    ...
    for i in range(len(OP_NAMES)):
        if is_show is None or is_show[i]:
            for b in BATCH_LIST_VALUE:
                if b <= least_B:
                    continue
                op_type, S_mul, S_add, S_in, S_out, S_wei = meta_info.ret_tf_metadata(OP_NAMES[i], batch_size=b)
                __record_xdata(S_mul, S_add, S_in, S_out, S_wei, GFLOPS_FP32, DATA_32["B=%d"%b][NAMELIST_32.index(OP_NAMES[i])])
                __record_xdata(S_mul, S_add, S_in, S_out, S_wei, GFLOPS_FP16, DATA_16["B=%d"%b][NAMELIST_16.index(OP_NAMES[i])])
...
def plot_2d_fit_result(is_show):
    ...
    def __plot(op_id, fig_base, fig_idx, only_16=False):
        ...
        x_axis_idx = 0
        xaxis = [b if x_axis_idx == 0 else meta_info.ret_tf_metadata(OP_NAMES[op_id], batch_size=b)[x_axis_idx] for b in BATCH_LIST_VALUE]

        ax = plt.subplot(fig_base)
        if not only_16:
            avgs = vary_batch_size(NAMELIST_32.index(OP_NAMES[op_id]))
            ax.plot(xaxis, avgs, marker='.', label=OP_SHORT_LABELS[op_id]+"_fp32")
        ...
        avgs_16 = vary_batch_size(NAMELIST_16.index(OP_NAMES[op_id]), fp16=True)
        ax.plot(xaxis, avgs_16, marker='^', label=OP_SHORT_LABELS[op_id]+"_fp16")
