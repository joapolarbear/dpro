...
if __name__ == '__main__':
    ...
    clct = Collector(
        ...
        zmq_log_path = args.zmq_log_path,
        server_log_path = args.server_log_path,
        disable_revise = args.disable_revise,
        update_clip_overlapping = args.update_clip_overlapping,
        nccl_algo = args.nccl_algo,
        update_barrier = args.update_barrier,
        ...
        if args.sub_option == "combine":
            ...
            while True:
                ...
                if name.lower() == "q":
                    ...
                    avg = clct.traceM.lookup_stat(args.comm_backend, None, None, name)
    ...
    if args.option == "optimize":
        ...
        if args.sub_option == "from_opfs2tsfs":
            ...
            local_dfg = wrap_read_gml(dag_path, clct.para_dict, args.pretty)
    ...
    if args.option == "topo_sort":
        ...
        dagmanager = DAGManager(pm.path, local_rank, platform=args.platform, update_barrier=args.update_barrier)
    ...
    if args.option == "critical":
        ...
        graphs = []
        for _dir in pm.dirs:
            dagmanager = DAGManager(os.path.join(pm.path, _dir), platform=args.platform, update_barrier=args.update_barrier)
    ...
    ### Output debug traces
    DebugRecorder().dump_traces(path_list[0])
